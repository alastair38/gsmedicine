		...
		<div class="col s12 black-text">
			<?php
				...
				if($privacy['cookies_page_link']) {
					echo '<br /><br /><a class="btn-large" href="' . $privacy['cookies_page_link'] . '">View Cookies Policy</a>';
				}
				echo '</p>';
			...
			?>
			<button type="button" class="btn" id="btn-revokeChoice">Revoke Cookie Consent</button>
		</div>
		<div class="col s12 black-text">
			<?php
				//$fieldObject = get_sub_field_object('how_we_protect_your_information', 'option');
